...
- Allow **dirname and **filename to be used as variable names.
  ([05722cc](https://github.com/milesj/packemon/commit/05722cc))
...
- Fix invalid repository directory. ([18611da](https://github.com/milesj/packemon/commit/18611da))
...
- Update downleveling to use pathToFileURL.
  ([72f61ef](https://github.com/milesj/packemon/commit/72f61ef))
...
- Add a new Babel plugin for CJS/ESM interop. (#82)
  ([cce0e90](https://github.com/milesj/packemon/commit/cce0e90)), closes
  [#82](https://github.com/milesj/packemon/issues/82)
