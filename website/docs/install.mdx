...
A project in the context of Packemon is either a package (polyrepo), or a collection of packages
(monorepo). Choose the option that best suits your needs.
